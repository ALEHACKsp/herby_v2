...
namespace vgui
{
	...
	struct Vertex_t
	{
		Vector2D m_Position, m_TexCoord;

		Vertex_t() {}
		Vertex_t(const Vector2D& pos, const Vector2D& coord = Vector2D())
		{
			m_Position = pos;
			m_TexCoord = coord;
		}
		void Init(const Vector2D& pos, const Vector2D& coord = Vector2D())
		{
			m_Position = pos;
			m_TexCoord = coord;
		}
	...
	public:
		...
		virtual void        DrawSetColor(ImColor col) = 0;
		...
		virtual void        DrawSetTextColor(ImColor col) = 0;
