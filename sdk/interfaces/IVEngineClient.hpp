...
{
public:
	virtual int						GetIntersectingSurfaces(const model_t* model, const Vector& vCenter, const float radius, const bool bOnlyVisibleSurfaces, SurfInfo* pInfos, const int nMaxInfos) = 0;		// 0
	...
	virtual bool					CpyFile(const char* source, const char* destination) = 0;
	...
	virtual bool					CheckDoneKeyTrapping(int& code) = 0;																																	// 25
	...
	virtual void					Sound_ExtraUpdate(void) = 0;																																			// 35
	...
	virtual struct IVoiceTweak_s* GetVoiceTweakAPI(void) = 0;																																			// 55
	...
	virtual int						SentenceGroupPick(int groupIndex, char* name, int nameBufLen) = 0;																									// 65
	...
	virtual int						GetOcclusionViewId(void) = 0;																																			// 75
	virtual void* SaveAllocMemory(size_t num, size_t size) = 0;
	virtual void					SaveFreeMemory(void* pSaveMem) = 0;
	virtual INetChannelInfo* GetNetChannelInfo(void) = 0;
	virtual void					DebugDrawPhysCollide(const CPhysCollide* pCollide, IMaterial* pMaterial, const matrix3x4_t& transform, const ImColor& color) = 0;
	...
	virtual unsigned				GetEngineBuildNumber() = 0; // engines build
	...
	virtual void					ClientCmd_Unrestricted_Unusable(char const*, int, bool) = 0;
	virtual void					ClientCmd_Unrestricted(const char* szCmdString, int we = 0) = 0; // 114
	...
	virtual unsigned				iOnStorageDeviceAttached(int iController) = 0;
